...
export const getServerSideProps = async (context)=> {
    ...
    try{
        console.log('Regenerating Support Page')
...
const Support = ({pageData}) => {
    const comps = ['Hero', 'LargeContentArea', 'SupportBlockArea']
    const {components, componentsData} = getComponentsAndComponentsData(pageData,comps)
    return ( 
